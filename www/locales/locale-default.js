var defaultLocale = {
  ...
  "user-guide":{
    ...
    "statistics":{
      ...
      "p1":"On the statistics screen you can see a chart showing the nutritiments you have consumed and variations in your weight during the selected time period.",
    ...
    "diary":{
      ...
      "p8":"If you would just like to record some calories without the hassle of adding an product to your food list first then you can do that too. Just double tap one of the categories in the diary page and enter the amount of calories."
    },
    "food-list":{
      "title":"Food List",
      ...
      "p4":"Tapping on an item in the list will select it. Once you've selected at least one item a tick will appear on the top toolbar, clicking this will add the selected items to your diary.",
      "p5":"You can edit a food item by double tapping it.",
      "p6":"Tap and hold on a food item to remove it from the list and your local database."
    },
    "adding-a-food":
    {
      "title":"Adding a Food",
    ...
    "import":
    {
      ...
      "p3":"Waistline version 2 is not backwards compatible with version 1, you can try to import data from version 1 but it might produce some strange results."
    },
    "licenses":
    {
      "title":"Licenses",
